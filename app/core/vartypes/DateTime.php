...
namespace App\Core\VarTypes;

use App\Exceptions\Core\VarTypes\DateTimeException;
...
class DateTime {
    ...
    public function modify(string $code) {
        ...
        if($code[0] == '+') {
            ...
            throw new DateTimeException('Unknown datetime modification operation.');
        }
        ...
        if($count === null) {
            throw new DateTimeException('Incorrect datetime modification value passed.');
        }
